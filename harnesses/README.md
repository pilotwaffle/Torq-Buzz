...
| `gemini.json` | Gemini CLI | `gemini-3.1-pro-preview` |
...
The DeepSeek harness includes `QWEN_CODE_API_TIMEOUT_MS=600000` so long Buzz prompts do not hit Qwen Code's shorter request timeout. Harness definitions do not contain API keys; Qwen and Gemini credentials stay in their own user-level CLI configuration.
